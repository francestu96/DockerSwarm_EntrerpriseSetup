...
class JConfig
{
	...
	public $password = 'user';                   // DB password
	public $db = 'joomla';                         // DB database name
	public $dbprefix = 'prfx_';               // Do not change unless you need to!
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = '/var/www/tmp';                // This path needs to be writable by Joomla!
